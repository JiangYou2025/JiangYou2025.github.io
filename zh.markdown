...
<header class="wrap profile" id="top">
  ...
  <div class="intro">
    ...
    <p class="tagline">
      研究方向：时间序列预测、异常检测与预测的深度学习方法，设计新型架构（Kernel U-Net）及鲁棒训练策略。
    </p>
    <div class="links">
      <a href="mailto:{{ site.author.email }}">✉ 邮箱</a>
      ...
      <a href="{{ '/assets/cv.pdf' | relative_url }}" target="_blank" rel="noopener">📄 简历</a>
    </div>
  </div>
</header>
...
<section id="about">
  <h2>关于</h2>
  <p>
    我是 ESIEE Paris（巴黎居斯塔夫·埃菲尔大学）的研究员。2024 年在巴黎东克雷泰伊大学（Université Paris-Est Créteil）完成博士学位，论文题为《时间序列预测、异常检测与预测》。研究聚焦于构建高效准确的时序数据模型，应用于能源、金融、工业及时空系统。
  </p>
  <p>研究方向：</p>
  <ul class="research-interests">
    <li>时间序列预测</li>
    <li>异常检测与异常预测</li>
    <li>面向时序数据的深度学习架构（Kernel U-Net）</li>
    <li>时空预测</li>
  </ul>
</section>
  ...
  <div class="news">
    <table>
      <tr>
        ...
        <td>论文被 <strong>ICASSP 2026</strong> 接收：<em>Enhancing Spatio-Temporal Forecasting with Spatial Neighbourhood Fusion</em>。</td>
      </tr>
      <tr>
        <td class="date">2025-05</td>
        <td>新预印本：<em>Dynamic Perturbed Adaptive Method for Infinite Task-Conflicting Time Series</em>。</td>
      </tr>
      <tr>
        <td class="date">2025</td>
        <td>新预印本：时空预测与空间邻域融合（秘鲁 COVID-19 出行数据）。</td>
      </tr>
      <tr>
        <td class="date">2024</td>
        <td>博士论文答辩：<em>Time Series Forecasting, Anomaly Detection and Prediction</em>，巴黎东克雷泰伊大学。</td>
      </tr>
      <tr>
        <td class="date">2024</td>
        <td>两篇论文分别在 <strong>INISTA 2024</strong> 和 <strong>ICCP 2024</strong> 发表。</td>
      </tr>
    </table>
  </div>
</section>
...
<section id="teaching">
  ...
  <div class="teaching-item">
    ...
    <p>神经网络架构、训练与应用的实践课程。</p>
  </div>
  <div class="teaching-item">
    <p class="role">强化学习 <span class="when">— 实验课 (TP), ESIEE Paris, 2021–2026</span></p>
    <p>马尔可夫决策过程、策略梯度、Q-learning 与深度强化学习实践。</p>
  </div>
</section>
